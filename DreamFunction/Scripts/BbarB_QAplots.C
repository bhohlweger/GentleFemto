...
std::cout << std::endl;
  ...
  DreamPlot::SetStyleHisto(hCutStats, 8, 2);
  hCutStats->Draw();
...
//  std::cout << "List " << listEvtCutsBefore->GetName()<< std::endl;
  ...
  DreamPlot::SetStyleHisto(hEvtCounter, 8, 2);
  DreamPlot::SetStyleHisto(hCutConfig, 2, 2);
  cEvtCounter->cd(1);
  hEvtCounter->Draw();
  cEvtCounter->cd(2);
...
// Defining a 1D histo which will have DCAxy in the x axis and the integrated signal in the y axis
  TH1F *hpTIntprotonDCAxyBefore = new TH1F("hpTIntprotonDCAxyBefore","histo",nbinsy,minyBefore,maxyBefore);

  for(int i = binminyBefore; i<binmaxyBefore; ++i) {

    float dcasign = 0.;
      for(int ii = binminxBefore; ii<binmaxxBefore; ++ii)
      {
        dcasign += hprotonDCAxyBefore->GetBinContent(ii,i);//it increases the dcasign by that
      }

    hpTIntprotonDCAxyBefore->SetBinContent(i,dcasign);
  }
  ...
  auto* cProtons = new TCanvas("Can_p","Can_p",0,0,5000,5000);
  cProtons->Divide(2,3);
  hprotonDCAxyAfter->GetYaxis()->SetRangeUser(-0.2,0.2);
  ...
  hprotonPhi->GetYaxis()->SetRangeUser(0,1.1*hprotonPhi->GetMaximum());
   ...
   DreamPlot::SetStyleHisto(hprotonDCAxyAfter, 8, 2);
   DreamPlot::SetStyleHisto(hprotonDCAz, 8, 2);
   DreamPlot::SetStyleHisto(hprotonPt, 8, 2);
   DreamPlot::SetStyleHisto(hprotonPhi, 8, 2);
   DreamPlot::SetStyleHisto(hprotonEta, 8, 2);
  cProtons->cd(1);
  hprotonDCAxyAfter->Draw("col");
  cProtons->cd(2);
  hprotonDCAz->Draw("col");
  cProtons->cd(3);
  hprotonPt->Draw();
  cProtons->cd(4);
  hprotonPhi->Draw();
  ...
  auto* hAntiprotonDCAxy = (TH2F*)listAntiTrackCutsAfter->FindObject("DCAXY_after");
  ...
  hAntiprotonDCAxy->GetYaxis()->SetRangeUser(-0.2,0.2);
  ...
  cAntiProtons->cd(1);
  hAntiprotonDCAxy->Draw("col");
  cAntiProtons->cd(2);
  hAntiprotonDCAz->Draw("col");
  cAntiProtons->cd(3);
  hAntiprotonPt->Draw();
  cAntiProtons->cd(4);
  hAntiprotonPhi->Draw();
...
std::cout << std::endl;
  ...
  auto* hlambdaK0InvMassCut = (TH1F*)listv0CutsCutsfolder->FindObject("InvMasswithCuts");
   ...
   DreamPlot::SetStyleHisto(hlambdaInvMass, 8, 2);
   DreamPlot::SetStyleHisto(hlambdaK0InvMassCut, 8, 4);
   hlambdaInvMass->Draw();
  ...
  DreamPlot::SetStyleHisto(hlambdaDecayVtxXPV, 8, 2);
  DreamPlot::SetStyleHisto(hlambdaDecayVtxYPV, 8, 4);
  DreamPlot::SetStyleHisto(hlambdaDecayVtxZPV, 8, 8);
  ...
  pL10->SetLogy();
  DreamPlot::SetStyleHisto(hlambdaDauPDCAToPV, 8, 2);
  DreamPlot::SetStyleHisto(hlambdaDauNDCAToPV, 8, 4);
  ...
  std::cout << std::endl;
    ...
    auto* hAntilambdaK0InvMassCut = (TH1F*)listAntiv0CutsCutsfolder->FindObject("InvMasswithCuts");
     ...
     DreamPlot::SetStyleHisto(hAntilambdaInvMass, 8, 2);
     DreamPlot::SetStyleHisto(hAntilambdaK0InvMassCut, 8, 4);
     hAntilambdaInvMass->Draw();
    ...
    DreamPlot::SetStyleHisto(hAntilambdaDecayVtxXPV, 8, 2);
    DreamPlot::SetStyleHisto(hAntilambdaDecayVtxYPV, 8, 4);
    DreamPlot::SetStyleHisto(hAntilambdaDecayVtxZPV, 8, 8);
    ...
    pAntiL10->SetLogy();
    DreamPlot::SetStyleHisto(hAntilambdaDauPDCAToPV, 8, 2);
    DreamPlot::SetStyleHisto(hAntilambdaDauNDCAToPV, 8, 4);
