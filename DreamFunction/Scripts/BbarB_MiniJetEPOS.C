...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void BbarB_MiniJetEPOS(const char* STflag = "", const bool writefile = false) {
DreamPlot::SetStyle();
...
std::cout << "Fitting range up to " << maxfit <<std::endl;
...
//Accessing all the directory in the root file
  ...
  file0MC[0]=TFile::Open("../../../BBbar/GentleFemto_Output/mc/CorrectBin/epos/MCCFOutput_pAp_App_st1.root");
  //proton-AntiLambda index = 1
  file0data[1]=TFile::Open("../../../BBbar/GentleFemto_Output/data/CorrectBin/CFOutput_pAL_ApL_st1.root");
  file0MC[1]=TFile::Open("../../../BBbar/GentleFemto_Output/mc/CorrectBin/epos/MCCFOutput_pAL_ApL_st1.root");
  //Antiproton-Lambda index = 3
  file0data[3]=TFile::Open("../../../BBbar/GentleFemto_Output/data/CorrectBin/CFOutput_pAL_ApL_st1.root");
  file0MC[3]=TFile::Open("../../../BBbar/GentleFemto_Output/mc/CorrectBin/epos/MCCFOutput_pAL_ApL_st1.root");

  file0data[2]=TFile::Open("../../../BBbar/GentleFemto_Output/data/CorrectBin/CFOutput_LAL_ALL_st1.root");
  file0MC[2]=TFile::Open("../../../BBbar/GentleFemto_Output/mc/CorrectBin/epos/MCCFOutput_LAL_ALL_st1.root");
  }
  else if(strcmp(STflag, add2)==0)
  {
  std::cout << "Sphericity [0.3,0.7] \n";
  file0data[0]=TFile::Open("../../../BBbar/GentleFemto_Output/data/CorrectBin/CFOutput_pAp_App_st2.root");
  file0MC[0]=TFile::Open("../../../BBbar/GentleFemto_Output/mc/CorrectBin/epos/MCCFOutput_pAp_App_st2.root");
  //proton-AntiLambda index = 1
  file0data[1]=TFile::Open("../../../BBbar/GentleFemto_Output/data/CorrectBin/CFOutput_pAL_ApL_st2.root");
  file0MC[1]=TFile::Open("../../../BBbar/GentleFemto_Output/mc/CorrectBin/epos/MCCFOutput_pAL_ApL_st2.root");
  //Antiproton-Lambda index = 3
  file0data[3]=TFile::Open("../../../BBbar/GentleFemto_Output/data/CorrectBin/CFOutput_pAL_ApL_st2.root");
  file0MC[3]=TFile::Open("../../../BBbar/GentleFemto_Output/mc/CorrectBin/epos/MCCFOutput_pAL_ApL_st2.root");

  file0data[2]=TFile::Open("../../../BBbar/GentleFemto_Output/data/CorrectBin/CFOutput_LAL_ALL_st2.root");
  file0MC[2]=TFile::Open("../../../BBbar/GentleFemto_Output/mc/CorrectBin/epos/MCCFOutput_LAL_ALL_st2.root");
  }
  else if(strcmp(STflag, add3)==0)
  {
  std::cout << "Sphericity [0.7,1.] \n";
  file0data[0]=TFile::Open("../../../BBbar/GentleFemto_Output/data/CorrectBin/CFOutput_pAp_App_st3.root");
  file0MC[0]=TFile::Open("../../../BBbar/GentleFemto_Output/mc/CorrectBin/epos/MCCFOutput_pAp_App_st3.root");
  //proton-AntiLambda index = 1
  file0data[1]=TFile::Open("../../../BBbar/GentleFemto_Output/data/CorrectBin/CFOutput_pAL_ApL_st3.root");
  file0MC[1]=TFile::Open("../../../BBbar/GentleFemto_Output/mc/CorrectBin/epos/MCCFOutput_pAL_ApL_st3.root");
  //Antiproton-Lambda index = 3
  file0data[3]=TFile::Open("../../../BBbar/GentleFemto_Output/data/CorrectBin/CFOutput_pAL_ApL_st3.root");
  file0MC[3]=TFile::Open("../../../BBbar/GentleFemto_Output/mc/CorrectBin/epos/MCCFOutput_pAL_ApL_st3.root");

  file0data[2]=TFile::Open("../../../BBbar/GentleFemto_Output/data/CorrectBin/CFOutput_LAL_ALL_st3.root");
  file0MC[2]=TFile::Open("../../../BBbar/GentleFemto_Output/mc/CorrectBin/epos/MCCFOutput_LAL_ALL_st3.root");
  }
  else if(strcmp(STflag, add4)==0)
  {
  file0data[0]=TFile::Open("../../../BBbar/GentleFemto_Output/data/CorrectBin/CFOutput_pAp_App_full.root");
  file0MC[0]=TFile::Open("../../../BBbar/GentleFemto_Output/mc/CorrectBin/epos/MCCFOutput_pAp_App_full.root");
  //proton-AntiLambda index = 1
  file0data[1]=TFile::Open("../../../BBbar/GentleFemto_Output/data/CorrectBin/CFOutput_pAL_ApL_full.root");
  file0MC[1]=TFile::Open("../../../BBbar/GentleFemto_Output/mc/CorrectBin/epos/MCCFOutput_pAL_ApL_full.root");
  //Antiproton-Lambda index = 3
  file0data[3]=TFile::Open("../../../BBbar/GentleFemto_Output/data/CorrectBin/CFOutput_pAL_ApL_full.root");
  file0MC[3]=TFile::Open("../../../BBbar/GentleFemto_Output/mc/CorrectBin/epos/MCCFOutput_pAL_ApL_full.root");

  file0data[2]=TFile::Open("../../../BBbar/GentleFemto_Output/data/CorrectBin/CFOutput_LAL_ALL_full.root");
  file0MC[2]=TFile::Open("../../../BBbar/GentleFemto_Output/mc/CorrectBin/epos/MCCFOutput_LAL_ALL_full.root");
  }
}
...
if(maxfit==0.4){
foldername = "/Users/Valentina/cernbox/Analysis/BBbar/GentleFemto_Output/MiniJetCheck/FitRangeDefault04/epos/";
foldernameplot = "/Users/Valentina/cernbox/Analysis/BBbar/GentleFemto_Output/MiniJetCheck/FitRangeDefault04/epos/Plot/";
}
else if(maxfit==0.3){
   foldername = "/Users/Valentina/cernbox/Analysis/BBbar/GentleFemto_Output/MiniJetCheck/FitRange03/epos/";
   foldernameplot = "/Users/Valentina/cernbox/Analysis/BBbar/GentleFemto_Output/MiniJetCheck/FitRange03/epos/Plot/";
}
else if(maxfit == 0.35){
   foldername = "/Users/Valentina/cernbox/Analysis/BBbar/GentleFemto_Output/MiniJetCheck/FitRange035/epos/";
   foldernameplot = "/Users/Valentina/cernbox/Analysis/BBbar/GentleFemto_Output/MiniJetCheck/FitRange035/epos/Plot/";
}
else if(maxfit == 0.5){
   foldername = "/Users/Valentina/cernbox/Analysis/BBbar/GentleFemto_Output/MiniJetCheck/FitRange05/epos/";
   foldernameplot = "/Users/Valentina/cernbox/Analysis/BBbar/GentleFemto_Output/MiniJetCheck/FitRange05/epos/Plot/";
}
if(writefile){
FILE *fp = fopen(foldername+"Fitparameters_EPOS.dat","a");
if (fp!=NULL) {
...
//------------------------------------------------
   ...
   TFile *file = new TFile(foldername+"MiniJetCheck_EPOS.root","UPDATE");
