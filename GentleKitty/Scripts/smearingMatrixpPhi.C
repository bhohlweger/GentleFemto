...
//        new TH2F(
//            "histSmearPhi",
//            "; #it{k}*_{p#minus#phi} (MeV/#it{c}); #it{k}*_{p#minus#phi} (MeV/#it{c})",
//            500, 0, 1000, 500, 0, 1000);
...
//    double PhiDecay[2] = { phiMass, 0. };
    ...
    while (i < nParticles) {
      ...
      if ((1.9<massCurrentPhi) && (massCurrentPhi< 2.0)) {
        histSmearSideband->Fill(kstarpKp, kstarpPhi);
        histSmear2Sideband->Fill(kstarpKm, kstarpPhi);
