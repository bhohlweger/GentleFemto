...
//  TF1* systematic = (TF1*) systFile->Get("SystError");
  VariationAnalysis* CoulombAnalysis = new VariationAnalysis("hCk_Reweighted","Coulomb", 34,
                                                      324);
//  VariationAnalysis* HALAnalysis = new VariationAnalysis("hCk_FixShiftedppVar", 26,
//                                                      81);
//  VariationAnalysis* ESCAnalysis = new VariationAnalysis("hCk_FixShiftedppVar", 26,
//                                                      81);
//  VariationAnalysis* analysis = new VariationAnalysis("hCk_ReweightedppVar", 26,
//                                                      81);
//  CoulombAnalysis->SetRadiusRanges(100, 0.9, 1.1);
  CoulombAnalysis->ReadFitFile(filename,false,false);
