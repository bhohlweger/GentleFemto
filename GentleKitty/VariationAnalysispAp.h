 ...
 *      all units in MeV
 */
#ifndef GENTLEKITTY_VARIATIONANALYSISPAP_H_
#define GENTLEKITTY_VARIATIONANALYSISPAP_H_
#include "TROOT.h"
#include "TH1F.h"
#include "TH1D.h"
#include "TNtuple.h"
...
class VariationAnalysispAp {
 public:
  VariationAnalysispAp(const char* histName);
  virtual ~VariationAnalysispAp();
