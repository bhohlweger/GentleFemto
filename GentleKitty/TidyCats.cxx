...
void TidyCats::GetCatsProtonProton(CATS* AB_pp, double GaussSourceSize,
	...
	static double PotPars1S0[10] = { 0, 0, NN_AV18, v18_Coupled3P2, 1, 1, 1, 0,
			0, 0 };
	static double PotPars3P0[10] = { 0, 0, NN_AV18, v18_Coupled3P2, 1, 1, 1, 1,
			1, 0 };
	static double PotPars3P1[10] = { 0, 0, NN_AV18, v18_Coupled3P2, 1, 1, 1, 1,
			1, 1 };
	static double PotPars3P2[10] = { 0, 0, NN_AV18, v18_Coupled3P2, 1, 1, 1, 1,
			1, 2 };
...
void TidyCats::GetCatsProtonLambda(CATS* AB_pL, double GaussSourceSize,
	...
	static double pLamPotPars1S0[10] =
			{ 0, 0, pL_UsmaniOli, 0, 0, 0, 0, 0, 0, 0 };
	static double pLamPotPars3S1[10] =
			{ 0, 0, pL_UsmaniOli, 0, 0, 0, 0, 1, 0, 1 };
...
//
	...
	static double pXimPotParsI0S1[10] = { 0, 0, pXim_HALQCD1, QCDTime, 0, -1, 1,
			1, 0, 1 }; // 9, 10, 11, 12
	static double pXimPotParsI1S0[10] = { 0, 0, pXim_HALQCD1, QCDTime, 1, 1, 1,
			0, 0, 0 }; //This is shit. Corresponds to 9-14 t
	static double pXimPotParsI1S1[10] = { 0, 0, pXim_HALQCD1, QCDTime, 1, 1, 1,
...
void TidyCats::GetCatsProtonXiMinus1530(CATS* AB_pXim1530,
		double GaussSourceSize, double* pars, int momBins, double kMin,
		double kMax) {
	const double Mass_p = TDatabasePDG::Instance()->GetParticle(2212)->Mass()
			* 1000;
