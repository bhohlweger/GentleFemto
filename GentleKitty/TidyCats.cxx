...
//
  static double pXimPotParsI0S0[11] = { 0, 0, pXim_HALQCD1, QCDTime, 0, -1, 1,
      0, 0, 0 };  //4th argument is the t parameter and can be:
  static double pXimPotParsI0S1[11] = { 0, 0, pXim_HALQCD1, QCDTime, 0, -1, 1,
      1, 0, 1 };  // 9, 10, 11, 12
  static double pXimPotParsI1S0[11] = { 0, 0, pXim_HALQCD1, QCDTime, 1, 1, 1, 0,
      0, 0 };  //This is shit. Corresponds to 9-14 t
  static double pXimPotParsI1S1[11] = { 0, 0, pXim_HALQCD1, QCDTime, 1, 1, 1, 1,
      0, 1 };  // this value 1-6
  if (StrongOn) {
...
void TidyCats::GetCatsProtonXiMinusCutOff(CATS* AB_pXim, double* pars, int momBins,
                                    double kMin, double kMax, bool StrongOn,
...
//
  static double pXimPotParsI0S0[11] = { 0, 0, pXim_HALQCD1, QCDTime, 0, -1, 1,
      0, 0, 0, cutOff };  //4th argument is the t parameter and can be:
  static double pXimPotParsI0S1[11] = { 0, 0, pXim_HALQCD1, QCDTime, 0, -1, 1,
      1, 0, 1, cutOff };  // 9, 10, 11, 12
  static double pXimPotParsI1S0[11] = { 0, 0, pXim_HALQCD1, QCDTime, 1, 1, 1, 0,
      0, 0, cutOff };  //This is shit. Corresponds to 9-14 t
  static double pXimPotParsI1S1[11] = { 0, 0, pXim_HALQCD1, QCDTime, 1, 1, 1, 1,
      0, 1, cutOff  };  // this value 1-6
  if (StrongOn) {
    AB_pXim->SetShortRangePotential(0, 0, fDlmPot, pXimPotParsI0S0);
    AB_pXim->SetShortRangePotential(1, 0, fDlmPot, pXimPotParsI0S1);
    AB_pXim->SetShortRangePotential(2, 0, fDlmPot, pXimPotParsI1S0);
