...
SideBandFit::SideBandFit() :
		fAnalysisFileUp(), fAnalysisFileDown(), fnormleft(200), fnormright(400), fRebin(
				5) {
...
void SideBandFit::SideBandCFs() {
	...
	for (int iSB = 0; iSB < 4; ++iSB) {
		fSideBands.emplace_back(
				new DreamPair(sideNames[iSB], fnormleft / 1000.,
						fnormright / 1000.));
	}
	fSideBands[0]->SetPair(fAnalysisFileUp->GetPairDistributions(0, 4, "Up"));
	fSideBands[1]->SetPair(
			fAnalysisFileUp->GetPairDistributions(1, 5, "AntiUp"));
	fSideBands[2]->SetPair(
			fAnalysisFileDown->GetPairDistributions(0, 4, "Down"));
	...
	TH1F* SideBandSumRebinNoShift = AddCF(CF1Rebinned_NoShift,
			CF2Rebinned_NoShift, CF3Rebinned_NoShift, CF4Rebinned_NoShift,
			"RebinnedNoShift");
	...
	TH1F* SideBandSumRebinShift = AddCF(CF1Rebinned_Shift, CF2Rebinned_Shift,
			CF3Rebinned_Shift, CF4Rebinned_Shift, "RebinnedShift");
	...
	TH1F* SideBandSumReweighted = AddCF(CF1Reweighted, CF2Reweighted,
			CF3Reweighted, CF4Reweighted, "Reweighted");
...
double SideBandFit::ParameterizationROOT(double* Momentum,
		double* PotPar) {
