 ...
 *      all units in MeV
 */
#ifndef GENTLEKITTY_VARIATIONANALYSISLAL_H_
#define GENTLEKITTY_VARIATIONANALYSISLAL_H_
#include "TROOT.h"
#include "TH1F.h"
#include "TH1D.h"
#include "TNtuple.h"
...
class VariationAnalysisLAL {
 public:
  VariationAnalysisLAL(const char* histName);
  virtual ~VariationAnalysisLAL();
