    ...
    fDataHistogram("data", ";mass [GeV];count", 100, 5.0, 5.6)
{
  ...
  AddObservable("Resolution",100. * GetParameter("sigma").GetLowerLimit() / GetParameter("mu").GetUpperLimit(),100. * GetParameter("sigma").GetUpperLimit() / GetParameter("mu").GetLowerLimit(),"#sigma / #mu", "[%]");
